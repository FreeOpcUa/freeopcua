...
class OutputChannel : public OpcUa::OutputChannel
{
public:
...
public:
  OpcUaBinarySerialization()
    ...
    , Stream(new OpcUa::Binary::OStream(Channel))
  {
  }
...
protected:
  ...
  OpcUa::Binary::OStream& GetStream()
  {
    return *Stream;
  }
...
private:
  ...
  std::unique_ptr<OpcUa::Binary::OStream> Stream;
};

class InputChannel : public OpcUa::InputChannel
{
public:
  InputChannel()
  {
...
public:
  OpcUaBinaryDeserialization()
    ...
    , Stream(new OpcUa::Binary::IStream(Channel))
  {
  }
...
protected:
  ...
  OpcUa::Binary::IStream& GetStream()
  {
    return *Stream;
  }
...
protected:
  ...
  std::unique_ptr<OpcUa::Binary::IStream> Stream;
};
