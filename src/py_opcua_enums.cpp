...
#define _value(X) value(#X, ObjectID:: X)
  ...
  ._value(ModellingRuleMandatory)
  ._value(ModellingRuleMandatoryShared)
  ._value(ModellingRuleOptional)
  ._value(ModellingRuleCardinalityRestriction)
  ._value(ModellingRuleExposesItsArray)
  ._value(RootFolder)
  ._value(ObjectsFolder)
  ._value(TypesFolder)
  ._value(ViewsFolder)
  ._value(ObjectTypes)
  ._value(VariableTypes)
  ._value(DataTypes)
  ._value(ReferenceTypes)
  ._value(NamingRule)
